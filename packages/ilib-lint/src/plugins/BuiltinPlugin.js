...
export const regexRules = [
    {
        ...
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/resource-url-match.md"
    },
    {
        type: "resource-matcher",
        ...
        regexps: [ "\\{\\w+\\}" ],
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/resource-named-params.md"
    },
    {
        ...
        regexps: [ "[\\uFF21-\\uFF3A\\uFF41-\\uFF5A]+" ],
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/resource-no-fullwidth-latin.md"
    },
    {
        type: "resource-target",
        ...
        regexps: [ "[\\uFF10-\\uFF19]+" ],
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/resource-no-fullwidth-digits.md"
    },
    {
        type: "resource-target",
        ...
        regexps: [ "[\\uFF01\\uFF05\\uFF1F]+" ],
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/resource-no-fullwidth-punctuation-subset.md",
        locales: "ja"
    },
        {
        type: "resource-target",
        ...
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/resource-no-space-between-double-and-single-byte-character.md",
        severity: "warning",
        locales: "ja"
    },
    {
        ...
        regexps: [ "[ｧ-ﾝﾞﾟ]+" ],
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/resource-no-halfwidth-kana-characters.md",
        severity: "warning"
    },
    {
        type: "resource-target",
        ...
        regexps: [ "[\\u1680\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u2028\\u2029\\u202F\\u205F\\u3000]+" ],
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/resource-no-double-byte-space.md",
        severity: "warning",
        locales: "ja"
    },
    {
        ...
        regexps: [ "(\\s+[\\u3001\\u3002\\u3008-\\u3011\\u3014-\\u301B]|[\\u3001\\u3002\\u3008-\\u3011\\u3014-\\u301B]\\s+)" ],
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/resource-no-space-with-fullwidth-punctuation.md",
        severity: "warning",
        locales: "ja"
    },
    {
        ...
        regexps: [ "(?:^|[^'])(?<match>''?\\{.*?\\}''?)" ],
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/source-no-escaped-curly-braces.md",
        severity: "error",
        useStripped: false
    },
    {
        ...
        regexps: [ "(?:^|[^'])(?<match>''?\\{.*?\\}''?)" ],
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/resource-no-escaped-curly-braces.md",
        severity: "error",
        useStripped: false
    },
    {
        ...
        regexps: [ "(?:^|[^'])(?<match>\\{[^}]*?-[^}]*\\})" ],
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/source-no-dashes-in-replacement-params.md",
        severity: "error"
    },
    {
        type: "resource-source",
        ...
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/source-no-lazy-plurals.md",
        severity: "warning"
    },
    {
        type: "resource-source",
        ...
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/source-no-manual-percentage-formatting.md",
        severity: "warning"
    },
    {
        type: "resource-source",
        ...
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/source-no-noun-replacement-params.md",
        severity: "error",
        useStripped: false
    },
    {
        ...
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/source-no-manual-currency-formatting.md",
        severity: "error"
    },
    {
        type: "resource-source",
        ...
        link: "https://github.com/ilib-js/ilib-mono/ilib-lint/blob/main/docs/source-no-manual-date-formatting.md",
        severity: "error"
    },
];
