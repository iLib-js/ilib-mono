 ...
 *
 * setup.js - shared Jest hooks for LocaleInfo tests
 */
...
/**
 * Register the common beforeAll / beforeEach hooks used by LocaleInfo Jest
 * suites. Call once inside each describe() block.
 */
export function setupLocaleInfoTests() {
    beforeAll(async () => {
        setLocale("en-US");
