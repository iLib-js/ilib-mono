...
/**
 * Return a basic hash of this trans unit in order to identify it uniquely
 * @returns {string} a hash of the current unit.
 */
TranslationUnit.prototype.hash = function() {
    return [this.project, this.file, this.key, this.sourceLocale].join('_');
};
