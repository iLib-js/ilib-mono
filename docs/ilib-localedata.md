...
<table>
  ...
  <tbody>
<tr>
    <td><a href="#module_DataCache">DataCache</a></td>
    <td></td>
    </tr>
<tr>
    <td><a href="#module_LocaleData">LocaleData</a></td>
    <td></td>
    </tr>
</tbody>
</table>
...
<dl>
<dt><a href="#getLocaleData">getLocaleData(pkg, options)</a> ⇒ <code>LocaleData</code> | <code>undefined</code></dt>
...
<a name="module_DataCache"></a>

## DataCache

* * *

<a name="module_LocaleData"></a>

## LocaleData

* [LocaleData](#module_LocaleData)
    * [~LocaleData](#module_LocaleData..LocaleData)
        * [new LocaleData(packageName, options)](#new_module_LocaleData..LocaleData_new)
        * _instance_
            * [.isSync()](#module_LocaleData..LocaleData+isSync) ⇒ <code>boolean</code>
            * [.loadData(params)](#module_LocaleData..LocaleData+loadData) ⇒ <code>Promise</code> \| <code>Object</code>
            * [.getRoots()](#module_LocaleData..LocaleData+getRoots) ⇒ <code>Array.&lt;string&gt;</code>
        * _static_
            * [.getGlobalRoots()](#module_LocaleData..LocaleData.getGlobalRoots) ⇒ <code>Array.&lt;string&gt;</code>
            * [.addGlobalRoot(the)](#module_LocaleData..LocaleData.addGlobalRoot)
            * [.removeGlobalRoot(the)](#module_LocaleData..LocaleData.removeGlobalRoot)
            * [.clearGlobalRoots()](#module_LocaleData..LocaleData.clearGlobalRoots)
            * [.ensureLocale(locale)](#module_LocaleData..LocaleData.ensureLocale) ⇒ <code>Promise</code>
            * [.checkCache(packageName, locale, basename)](#module_LocaleData..LocaleData.checkCache) ⇒ <code>boolean</code>
            * [.cacheData(packageName, data)](#module_LocaleData..LocaleData.cacheData)
            * [.clearCache()](#module_LocaleData..LocaleData.clearCache)


* * *

<a name="module_LocaleData..LocaleData"></a>
...
**Kind**: inner class of [<code>LocaleData</code>](#module_LocaleData)  
...
<a name="new_module_LocaleData..LocaleData_new"></a>
...
<a name="module_LocaleData..LocaleData+isSync"></a>
...
**Kind**: instance method of [<code>LocaleData</code>](#module_LocaleData..LocaleData)  
**Returns**: <code>boolean</code> - whether or not the default for this local data instance
loads data synchronously  

* * *

<a name="module_LocaleData..LocaleData+loadData"></a>
...
<a name="module_LocaleData..LocaleData+getRoots"></a>
...
<a name="module_LocaleData..LocaleData.getGlobalRoots"></a>
...
**Kind**: static method of [<code>LocaleData</code>](#module_LocaleData..LocaleData)  
**Returns**: <code>Array.&lt;string&gt;</code> - the list of roots shared by all instances of LocaleData  

* * *

<a name="module_LocaleData..LocaleData.addGlobalRoot"></a>
...
<a name="module_LocaleData..LocaleData.removeGlobalRoot"></a>
...
<a name="module_LocaleData..LocaleData.clearGlobalRoots"></a>
...
<a name="module_LocaleData..LocaleData.ensureLocale"></a>
...
<a name="module_LocaleData..LocaleData.checkCache"></a>
...
<a name="module_LocaleData..LocaleData.cacheData"></a>
...
<a name="module_LocaleData..LocaleData.clearCache"></a>
...
## getLocaleData(pkg, options) ⇒ <code>LocaleData</code> \| <code>undefined</code>
Return the locale data singleton for a package that needs data.

**Kind**: global function  
**Returns**: <code>LocaleData</code> \| <code>undefined</code> - a locale data instance you can use
