/*
 * index.js - ilib string subclass that allows you to access
 ...
 */
class GlyphString extends IString {
    /**
     * Create a new ilib glyph string instance.<p>
     *
     * @constructor
     ...
     * @param {string} options.locale locale of this string
     */
     ...
     * @param {string} options.locale the locale to get the info for
    ...
    truncate(length) {
        ...
        let tr = "";
        for (let i = 0; i < length-1 && it.hasNext(); i++) {
            tr += it.next();
        }
