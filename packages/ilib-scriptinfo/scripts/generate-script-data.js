...
function generateScriptData() {
    try {
        ...
        const ilibScriptsPath = path.join(__dirname, '../node_modules/ilib/locale/scripts.json');
        ...
        const ucdFullPath = path.join(__dirname, '../node_modules/ucd-full/ScriptInfo.json');
