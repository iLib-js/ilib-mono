...
var PseudoFactory = function(options) {
    ...
    if (style === 'debug-asian') style = 'debug-han-simplified';
    ...
    switch (style) {
        ...
        case 'debug-han-simplified':
            logger.trace('Debug debug-han-simplified pseudo for locale ' + options.targetLocale);
            return new RegularPseudo({
                set: options.set,
                type: type,
                sourceLocale: sourceLocale.getSpec(),
        ...
        case 'debug-cyrillic':
            logger.trace('Debug cyrillic pseudo for locale ' + options.targetLocale);
            return new RegularPseudo({
                set: options.set,
                type: type,
                sourceLocale: sourceLocale.getSpec(),
