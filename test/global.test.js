/*
 * JSUtils.test.js - test the ilibCommon common
 *
...
describe("testGlobal", () => {
    ...
    test("ExtendSimple", () => {
        ...
        expect(object1).toEqual({"a": "A", "b": "B", "c": "C", "d": "D"});
    });
    ...
    test("ExtendArrays", () => {
        ...
        JSUtils.extend(object1, object2);
        expect(object1).toEqual({"a": ["b", "c", "d"]});
    });
    ...
    test("ExtendArraysDups", () => {
        ...
        JSUtils.extend(object1, object2);
        expect(object1).toEqual({"a": ["b", "c", "c", "d"]});
    });
    ...
    test("ExtendSimpleProperty", () => {
        ...
        JSUtils.extend(object1, object2);
        expect(object1).toEqual({"a": "A", "b": "X"});
    });
    ...
    test("ExtendSubobjects", () => {
        ...
        JSUtils.extend(object1, object2);
        expect(object1).toEqual({"b": {"x": "M", "y": "N"}});
    });
    ...
    test("ExtendBooleans", () => {
        ...
        JSUtils.extend(object1, object2);
        expect(object1).toEqual({"a": true, "b": false});
    });
    ...
    test("ExtendAddBooleans", () => {
        ...
        JSUtils.extend(object1, object2);
        expect(object1).toEqual({"a": true, "b": true, "c": false});
    });
    ...
    test("ExtendNumbers", () => {
        ...
        JSUtils.extend(object1, object2);
        expect(object1).toEqual({"a": 1, "b": 3});
    });
    ...
    test("ExtendNumbersWithZero", () => {
        ...
        JSUtils.extend(object1, object2);
        expect(object1).toEqual({"a": 1, "b": 0});
    });
    ...
    test("ExtendNumbersAddZero", () => {
        ...
        JSUtils.extend(object1, object2);
        expect(object1).toEqual({"a": 1, "b": 2, "c": 0});
    });
});
