...
describe("testPropertiesParser", () => {
    ...
    test("PropertiesParserConstructorTargetPath", () => {
        ...
        const sourceFile = new SourceFile("./test/testfiles/test_de-DE.properties", { sourceLocale: "en-US" });
        const fileInfo = parser.guessLocaleAndFindSourcePath(sourceFile);
        expect(fileInfo).toBeTruthy();
        expect(fileInfo.sourceLocale).toBe("en-US");
        expect(fileInfo.targetLocale).toBe("de-DE");
        expect(fileInfo.sourcePath).toBe("./test/testfiles/test.properties");
        expect(fileInfo.targetPath).toBe("./test/testfiles/test_de-DE.properties");
    });
    ...
    test("PropertiesParserConstructorSourcePathNoLocale", () => {
        ...
        const sourceFile = new SourceFile("./test/testfiles/test.properties", { sourceLocale: "en-US" });
        const fileInfo = parser.guessLocaleAndFindSourcePath(sourceFile);
        expect(fileInfo).toBeTruthy();
        expect(fileInfo.sourceLocale).toBe("en-US");
        expect(fileInfo.targetLocale).toBeFalsy();
        expect(fileInfo.sourcePath).toBe("./test/testfiles/test.properties");
        expect(fileInfo.targetPath).toBeFalsy();
    });
    ...
    test("PropertiesParserConstructorTargetPathWithSourceLocale", () => {
        ...
        const sourceFile = new SourceFile("./test/testfiles/strings_de-DE.properties", { sourceLocale: "en-US" });
        const fileInfo = parser.guessLocaleAndFindSourcePath(sourceFile);
        expect(fileInfo).toBeTruthy();
        expect(fileInfo.sourceLocale).toBe("en-US");
        expect(fileInfo.targetLocale).toBe("de-DE");
        expect(fileInfo.sourcePath).toBe("./test/testfiles/strings_en-US.properties");
        expect(fileInfo.targetPath).toBe("./test/testfiles/strings_de-DE.properties");
    });
    ...
    test("PropertiesParserConstructorSourcePathWithSourceLocale", () => {
        ...
        const sourceFile = new SourceFile("./test/testfiles/strings_en-US.properties", { sourceLocale: "en-US" });
        const fileInfo = parser.guessLocaleAndFindSourcePath(sourceFile);
        expect(fileInfo).toBeTruthy();
        expect(fileInfo.sourceLocale).toBe("en-US");
        expect(fileInfo.targetLocale).toBeFalsy();
    ...
    test("PropertiesParserConstructorTargetPathWithSharedSourceLocale", () => {
        ...
        const sourceFile = new SourceFile("./test/testfiles/resources_de-DE.properties", { sourceLocale: "en-US" });
        const fileInfo = parser.guessLocaleAndFindSourcePath(sourceFile);
        expect(fileInfo).toBeTruthy();
        expect(fileInfo.sourceLocale).toBe("en-US");
        expect(fileInfo.targetLocale).toBe("de-DE");
        expect(fileInfo.sourcePath).toBe("./test/testfiles/resources_en.properties");
        expect(fileInfo.targetPath).toBe("./test/testfiles/resources_de-DE.properties");
    });
    ...
    test("PropertiesParserConstructorSourcePathWithSharedSourceLocale", () => {
        ...
        const sourceFile = new SourceFile("./test/testfiles/resources_en.properties", { sourceLocale: "en-US" });
        const fileInfo = parser.guessLocaleAndFindSourcePath(sourceFile);
        expect(fileInfo).toBeTruthy();
        expect(fileInfo.sourceLocale).toBe("en-US");
        expect(fileInfo.targetLocale).toBeFalsy();
    ...
    test("PropertiesParserConstructorTargetPathWithNoBasename", () => {
        ...
        const sourceFile = new SourceFile("./test/testfiles/de-DE.properties", { sourceLocale: "en-US" });
        const fileInfo = parser.guessLocaleAndFindSourcePath(sourceFile);
        expect(fileInfo).toBeTruthy();
        expect(fileInfo.sourceLocale).toBe("en-US");
        expect(fileInfo.targetLocale).toBe("de-DE");
        expect(fileInfo.sourcePath).toBe("./test/testfiles/en-US.properties");
        expect(fileInfo.targetPath).toBe("./test/testfiles/de-DE.properties");
    });
    ...
    test("PropertiesParserConstructorSourcePathWithNoBasename", () => {
        ...
        const sourceFile = new SourceFile("./test/testfiles/en-US.properties", { sourceLocale: "en-US" });
        const fileInfo = parser.guessLocaleAndFindSourcePath(sourceFile);
        expect(fileInfo).toBeTruthy();
        expect(fileInfo.sourceLocale).toBe("en-US");
        expect(fileInfo.targetLocale).toBeFalsy();
    ...
    test("PropertiesParserParseReadSourceFile", () => {
        ...
        const sourceFile = new SourceFile("./test/testfiles/strings_en-US.properties", { sourceLocale: "en-US" });
        const actual = parser.parse(sourceFile);
        expect(actual).toBeTruthy();
        ...
        expect(ir.getSourceFile()).toBe(sourceFile);
    ...
    test("PropertiesParserParseReadTargetFileWithNoSourceFile", () => {
        ...
        const sourceFile = new SourceFile("./test/testfiles/test2_de-DE.properties", { sourceLocale: "en-US" });
        const actual = parser.parse(sourceFile);
        expect(actual).toBeTruthy();
    ...
    test("PropertiesParserParseSomeStringsHaveNoSource", () => {
        ...
        const sourceFile = new SourceFile("./test/testfiles/test3_de-DE.properties", { sourceLocale: "en-US" });
        const actual = parser.parse(sourceFile);
        expect(actual).toBeTruthy();
