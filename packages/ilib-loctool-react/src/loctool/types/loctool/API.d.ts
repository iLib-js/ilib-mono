...
declare module "loctool" {
    ...
    type NewResourceOptions<T extends ResType = ResType> =
        BaseResourceOptions<T> & ResourceOptionsMap[T];
    ...
    export class API {
         ...
         */
        newResource<T extends ResType>(
            options: NewResourceOptions<T>
        ): InstantiatedResource<T>;
         ...
         */
        newTranslationSet<R extends Resource = Resource>(
            sourceLocale?: string
        ): TranslationSet<R>;
